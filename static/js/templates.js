...
$('#expert-select').on("change", function(){
  data=$("#expert-select").select2('data')[0];
    if ($(this).select2('data').length) {
     $('#product-commission').val($(this).select2('data')[0].commission);
     $('#product-commission2').val($(this).select2('data')[0].commission_2);
    }
...
console.log($uid);
   ...
   $.post( $getProductEndpoint, {'uid': $uid} )
                              ...
                              .done(function( data ) {
                                        ...
                                        $('#product-commission').val(data['commission']);
                                        $('#product-commission2').val(data['commission_2']);
